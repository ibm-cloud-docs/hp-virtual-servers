...
![Migrating by not having ssh access](image/Migrate_withoutSSHAccess.JPEG "Migrating by not having ssh access"){: caption="Figure 2. Migrating by not having ssh access" caption-side="bottom"}
